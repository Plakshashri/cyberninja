...
function Signup() {
  ...
  return (
    <div className='max-w-[50vmax] m-auto mt-30 shadow-xl/20 p-10 rounded-[50%]'>
      <h2 style={{ fontFamily: "Dancing Script, cursive" }} className='text-center text-5xl bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-purple-500'>Signup</h2>
      <form className='flex flex-col items-center justify-center gap-15' onSubmit={handleSubmit}>
        ...
        hover:bg-black hover:text-white cursor-pointer transition-all duration-500 ease-in-out' type="submit">Signup</button>
        {message && <p>{message}</p>}
      </form>
    </div>
  );
